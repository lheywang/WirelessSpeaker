...
{
    uint8_t Voltage
        [2]; /*!< Voltage requested for this PDO. Form is Int.Float, with float a number of 20 mV steps.*/
    uint8_t Current
        [2]; /*!< Current requested for this PDO. Form is Int.Float, with float a number of 50 mA steps.*/
