...
if __name__ == "__main__":
    ...
    match(jindex):
        ...
        case 0:
            ...
            options = ["RC (1st order)", "Sallen-Key (2nd order)", "Multiple Feedback (2nd order)"]
            ftopo, ftindex = pick(options, title)

            if (ftindex < 1) and (findex > 1):
                print("Unable to design band filter with a simple RC ! Please select a second order filter at least !")
                exit(-1)
            ...
            while True:
                try:
                    ...
                    if (ftindex > 0):
                        F = float(input("Please enter the cutoff frequency (or the central frequency) : "))
                        K = float(input("Please enter the gain of the system : "))
                        Q = float(input("Please enter the quality factor of the filter : "))
            ...
            match(findex):
                ...
                case 0:
                    ...
                    if (ftindex == 1):
                        ...
                        print("The designed filter shall use theses values (SHiwed according MT222 from Analog Devices representation)")
                        print(f"R1 = {R1} Ohms")
                        print(f"R2 = {R2} Ohms")
                        print(f"R4 = {R4} Ohms")
                    ...
                    if (ftindex == 2):
                        ...
                        print("The designed filter shall use theses values (SHiwed according MT220 from Analog Devices representation)")
                        print(f"R1 = {R1} Ohms")
                        print(f"R3 = {R3} Ohms")
                        print(f"R4 = {R4} Ohms")
                        print(f"C2 = {C2 * PrintFactor} nF")
                ...
                case 1:
                    ...
                    if (ftindex == 1):
                        ...
                        print(f"R4 = {R4} Ohms")
                        if (R4 == 0):
                            print(f"Due to K = 1 requirement, please ensure also R3 = 0. Values are already computed with it.")
                        print(f"C2 = {C2 * PrintFactor} nF")
                        print("And for reminder, you enterred theses values :")
                        print(f"R3 = {RF} Ohms")
                        print(f"C1 = {CF * PrintFactor} nF")
                ...
                case 2:
                    ...
                    if (ftindex == 1):
                        ...
                        print(f"R5 = {R5} Ohms")
                        if (R5 == 0):
                            print(f"Due to K = 1 requirement, please ensure also R4 = 0. Values are already computed with it.")
                        print(f"C2 = {C2 * PrintFactor} nF")
