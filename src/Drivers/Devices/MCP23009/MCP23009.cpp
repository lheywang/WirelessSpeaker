...
int MCP23009::ConfigureGPIO(const int Direction, const int Polarity, const int EnablePullUps, const int EnableInterrupts, const int IOC, const int DefaultValue)
{
