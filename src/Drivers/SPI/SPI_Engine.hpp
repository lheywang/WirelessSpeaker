...
struct SPI_Bus
{
    ...
    unsigned char
        delay; /*!< Defined automatically. Store the SPI Bus delay between CS and first cycle.*/
    unsigned char bits; /*!< Defined automatically. Store the SPI Bus number of bits per cycle.*/
    unsigned char
        change; /*!< Defined automatically. Store the SPI Bus change speed after last cycle.*/
