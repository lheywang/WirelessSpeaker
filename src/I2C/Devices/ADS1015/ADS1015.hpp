...
public:
     ...
     *
     * @param channel (int) : The channel selected.
     * @param value (float*) : A pointer to a float to store the output value
     *
     * @return (int) : The function return code
     *      -1 : Channel set is under the minimum value
     *      -2 : Channel set is over the maximum value
     *      -3 : value pointer incorrect
     */
     ...
     *
     * @param channel (int) : Selected channel. Will be overwritten by reading functions
     * @param gain  (int) : Gain of the PGA
     * @param mode (int) : Operation mode
     * @param sampling_frequency (int)
     * @param comparator_mode (int)
     * @param comparator_polarity (int)
     * @param comparator_latching (int)
     * @param comparator_name (int)
     *
