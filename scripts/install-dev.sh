...
apt-get install -y build-essential libc6-dev make doxygen ssh libi2c-dev device-tree-compiler g++-aarch64-linux- cmake texlive-full libfdt-dev gcc graphviz python3.11 clang-format
